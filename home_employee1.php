...
<html lang="en">
  ...
  <body>
      ...
      <div class="masthead nprint">
        ...
        <br>
          <div class="well bs-component">
              <fieldset>
                <button type="button" id="addNew" data-toggle="modal" data-target="#addEmployee" class="btn btn-success" style="margin-top:-10px;">Add New</button>
                <br><br>  
                ...
                if(isset($_POST['filterBtn']))
                {
                  ...
                  echo "
                  <script>
                  window.location = 'home_employee1.php?yyyy=$year&mm=$month';
                  </script>
                  ";
                }
                ?>
    ...
    border: none;color: white;padding: 15px 32px;text-align: center; text-decoration: none;display: inline-block;font-size: 16px;margin: 4px 2px;cursor: pointer; border-radius:10px;font-size:15px;">Print this page</button>
                    ...
                    <table class="table table-bordered table-hover table-condensed" id="myTable">
                      ...
                      <thead>
                        <tr class="info">
                          ...
                          <th><p align="center">Home Rent</p></th>
                          <th><p align="center">Inflation Allowance 24%</p></th>
                          <th><p align="center">Inflation Allowance 31%</p></th>
                          <th><p align="center">Medical Allowance</p></th>
                          <th><p align="center">CCA</p></th>
                          ...
                          <th><p align="center">PF Double</p></th>
                          <th><p align="center">ESI</p></th>
                          <th><p align="center">ESI MC Share</p></th>
                          ...
                          <th class="nprint"><p align="center">Options</p></th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php
                        ...
                        $empp = "SELECT * FROM contarct1 where MONTH = '$mm' and YEAR = '$yyyy' ORDER BY NAME";
                        ...
                        <tr>
                          ...
                          <td align="center"><?php echo $row[22] ?></td>
                          <td align="center">
                            <a class="btn btn-primary" href="view_employee1.php?id=<?php echo $row[0]; ?>" title="Update">Update</a>
                            <a class="btn btn-danger" href="delete1.php?id=<?php echo $row['id']; ?>" style="display:block">Delete</a>
                          </td>
                        </tr>
            ...
            <div class="modal-body" style="padding:40px 50px;">
              ...
              <form class="form-horizontal" action="#" name="form" method="post" autocomplete="off" onsubmit="return checkVal()">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input oninput="findName()" id="name" type="text" name="name" class="form-control" placeholder="Name" required="required">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="rate" id="rate" onkeyup="calculate()" class="form-control" placeholder="Rate" required="required">
                  </div>
                </div>
                 <div class="form-group">
                  <label class="col-sm-4 control-label">Payble Value</label>
                  <div class="col-sm-8">
                    <input onkeyup="calculate2()" type="text" name="pvalue" id="pvalue" class="form-control" placeholder="Payble Value" required="required">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input onkeyup="calcTotal()" type="text" name="homerent" id="homerent" class="form-control" placeholder="Home Rent" required="required">
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input onkeyup="calcTotal()" type="text" name="iallowance24" id="iallowance24" class="form-control" placeholder="inflation allowance" required="required">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input onkeyup="calcTotal()" type="text" name="iallowance31" id="iallowance31" class="form-control" placeholder="inflation allowance" required="required">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input onkeyup="calcTotal()" type="text" name="mallowance" id="mallowance" class="form-control" placeholder="inflation allowance" required="required">
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input onkeyup="calcTotal()" type="text" name="cca" id="cca" class="form-control" placeholder="CPF" required="required">
                  </div>
                </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input onkeyup="calcTotal()" type="text" name="cpfmcs" id="cpfmcs" class="form-control" placeholder="ESI" required="required">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input onkeyup="calcTotal()" type="text" name="esimcs" id="esimcs" class="form-control" placeholder="ESIMC" required="required">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="salary" id="salary" class="form-control" placeholder="ESIMC" required="required">
                  </div>
                </div>
                <br>
                ...
                <br>
                 <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input onkeyup="calcDeduction()" type="text" name="pfdoubles" id="pfdoubles" class="form-control" placeholder="PFDoubles" required="required">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input onkeyup="calcDeduction()" type="text" name="esi" id="esi" class="form-control" placeholder="ESI SCR" required="required">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-4 control-label">ESI MC Share</label>
                  <div class="col-sm-8">
                    <input onkeyup="calcDeduction()" type="text" name="esimc" id="esimc" class="form-control" placeholder="ESIMC" required="required">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input onkeyup="calcDeduction()" type="text" name="loan" id="loan" class="form-control" placeholder="Loan Recovery" required="required">
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input onkeyup="calcDeduction()" type="text" name="recovery" id="recovery" class="form-control" placeholder="Recovery" required="required">
                  </div>
                </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="sign" class="form-control" placeholder="Signature" required="required">
                  </div>
                </div>
