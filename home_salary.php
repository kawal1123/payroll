...
$over = "SELECT * from overtime";
  $query  = mysqli_query($connection,$over);
  ...
  $query  = mysqli_query($connection,$salary);
  while($row=mysqli_fetch_array($query))
  {
                  ...
                  <form method="post" action="" >
                    <table class="table table-bordered table-hover table-condensed" id="myTable">
                      ...
                      <tbody>
                        ...
                        $otime = "SELECT * from overtime";
                          $query  = mysqli_query($connection,$otime);
                          while($row=mysqli_fetch_array($query))
                          {
                            $rate   = $row['rate'];
                          }

                          $sal = "SELECT * from salary";

                          $query  = mysqli_query($connection,$sal);
                          while($row=mysqli_fetch_array($query))
                          {
                          ...
                          $query  = mysqli_query($connection,$emp);
                          while($row=mysqli_fetch_array($query))
                          {
                            $lname           = $row['lname'];
                            $fname           = $row['fname'];
